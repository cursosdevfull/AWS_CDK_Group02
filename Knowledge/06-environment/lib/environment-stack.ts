...
interface MicroserviceEnvironmentNestedProps extends StackProps {
    env: { account: string; region: string };
}

class MicroserviceTableStack extends NestedStack {
    constructor(scope: Construct, id: string, props?: MicroserviceEnvironmentNestedProps) {
        super(scope, id, props);
        ...
        new dynamodb.TableV2(this, "microservice-table-stack-nested", {
            ...
            tableName: `microservice-table-${region}-new`
        })
    }
}

export class MicroserviceEnvironmentNested extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        super(scope, id, props);
